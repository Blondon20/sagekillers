...
<div class="wrapper">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <router-link to="/liste-employee" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Liste personnels</p>
                </router-link>
              </li>
              <li class="nav-item">
                <router-link to="/fonction" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Gestion fonctions</p>
                </router-link>
              </li>
              <li class="nav-item">
              ...
              <li class="nav-item">
                <router-link to="/livraison" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Livraison validée</p>
                </router-link>
              </li>
            </ul>
          </li>
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="pages/charts/chartjs.html" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Transfert dépot à dépot</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="pages/charts/flot.html" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Transfert inter-agence</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="#" class="nav-link">
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <!-- Contenue dynamique de l'application -->
